...
<title>The Cheapest | Admin | Edit Store</title>  
@section('content')
 <!-- ########## START: MAIN PANEL ########## -->
 <div class="sl-mainpanel">
    ...
    <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Update store data</h6>
        
          <form action="{{url('admin/update/store/'.$store->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row mg-b-25">
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="name"  placeholder="Enter name" value="{{$store->name}}">
                </div>
              </div><!-- col-4 -->
                <div class="col-lg-6">
                <div class="form-group">
              ...
              <div class="col-lg-6">
                <div class="form-group mg-b-10-force">
                  ...
                  <select class="form-control select2" data-placeholder="Choose manager" name="manager_id">
                    <option value="{{$store->manager->name}}"></option>
